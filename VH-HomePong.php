...
<meta charset="UTF-8">
    ...
    <title>VH-Homepage</title> 
    <link rel="stylesheet" href="VH-HomePong.css">
...
<ul class="MENUBAR">
  ...
  <li><a class="active" href="http://localhost/VH-HomePong.php">สถิติ</a></li>
...
// 2. กำหนดรูปแบบคำสั่ง SQL
$stmt = $pdo->prepare("SELECT count(c.cid) as positiveday
from cases c
